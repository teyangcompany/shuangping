...
var _jqueryVendor = __webpack_require__(90);
...
var _lmwTimeFormat = __webpack_require__(100);
...
var _pie = __webpack_require__(172);

var _pie2 = _interopRequireDefault(_pie);

var _bar = __webpack_require__(506);

var _bar2 = _interopRequireDefault(_bar);

var _line = __webpack_require__(507);

var _line2 = _interopRequireDefault(_line);

var _sszxqk = __webpack_require__(508);

var _sszxqk2 = _interopRequireDefault(_sszxqk);

var _sspjqk = __webpack_require__(509);
    ...
    var mySwiper = new Swiper(".liang-swiper", {
        ...
        onInit: function onInit() {
            ...
            typeArr.forEach(function (type) {
                var line = [];
                for (var i = 0; i < 7; i++) {
                    var day = (0, _lmwTimeFormat2.default)(new Date().getTime() + i * 24 * 3600 * 1000, "%m月%d日");
...
(0, _api2.default)("nethos.demo.bookorder.list", {}).then(function (res) {
    console.log(res);
});
...
(0, _jqueryVendor2.default)("#yygh-total").data("refresh", 1);
(0, _jqueryVendor2.default)("#yygh-total").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(400) }, { name: "A", text: "APP(A)", value: getDemoValue(380) }, { name: "X", text: "线上(X)", value: getDemoValue(360) }]);

(0, _jqueryVendor2.default)("#yygh-mouth").data("refresh", 1);
(0, _jqueryVendor2.default)("#yygh-mouth").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(100) }, { name: "A", text: "APP(A)", value: getDemoValue(95) }, { name: "X", text: "线上(X)", value: getDemoValue(90) }]);
(0, _jqueryVendor2.default)("#yygh-week").data("refresh", 1);
(0, _jqueryVendor2.default)("#yygh-week").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(25) }, { name: "A", text: "APP(A)", value: getDemoValue(24) }, { name: "X", text: "线上(X)", value: getDemoValue(20) }]);
(0, _jqueryVendor2.default)("#online-total").data("refresh", 1);
(0, _jqueryVendor2.default)("#online-total").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(550) }, { name: "A", text: "APP(A)", value: getDemoValue(600) }, { name: "X", text: "线上(X)", value: getDemoValue(500) }]);
(0, _jqueryVendor2.default)("#online-month").data("refresh", 1);
(0, _jqueryVendor2.default)("#online-month").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(140) }, { name: "A", text: "APP(A)", value: getDemoValue(150) }, { name: "X", text: "线上(X)", value: getDemoValue(135) }]);
(0, _jqueryVendor2.default)("#online-week").data("refresh", 1);
(0, _jqueryVendor2.default)("#online-week").data("data", [{ name: "V", text: "微信(V)", value: getDemoValue(17) }, { name: "A", text: "APP(A)", value: getDemoValue(20) }, { name: "X", text: "线上(X)", value: getDemoValue(15) }]);
...
//# sourceMappingURL=page2.cee8a5b5e785142304de.js.map